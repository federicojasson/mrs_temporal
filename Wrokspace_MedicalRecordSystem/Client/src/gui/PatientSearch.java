...
public class PatientSearch extends JFrame {
	...
	public PatientSearch() {
		...
		Campos.setModel(new DefaultComboBoxModel(new String[] {"Nombre", "Fecha Nac.", "Sexo", "Sangre"}));
	...
	private void fillPatients(String searchCriteria){
		...
		try{
			...
			this.modelTablaPacientes = new DefaultTableModel(data, new String[] {"Nombre", "F. Nac.", "Sexo", "Sangre"});
