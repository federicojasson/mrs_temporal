...
public class AddStudyFrame extends GuiFrame {
	...
	protected JPanel getMainPanel() {
		...
		JScrollPane panelCausesContainer = new JScrollPane(fieldCauses, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		...
		JScrollPane panelDiagnosisContainer = new JScrollPane(fieldDiagnosis, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		...
		JScrollPane panelIndicationsContainer = new JScrollPane(fieldIndications, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		...
		JScrollPane panelObservationsContainer = new JScrollPane(fieldObservations, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		...
		JScrollPane panelStudyFilesContainer = new JScrollPane(listStudyFiles, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
