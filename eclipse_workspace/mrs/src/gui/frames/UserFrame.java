...
public class UserFrame extends GuiFrame {
	...
	protected JPanel getMainPanel() {
		...
		JScrollPane panelPatients = new JScrollPane(tablePatients, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
