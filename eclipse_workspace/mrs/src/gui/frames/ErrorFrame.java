...
public class ErrorFrame extends GuiFrame {
	...
	protected JPanel getMainPanel() {
		...
		JScrollPane panelErrorDetailsContainer = new JScrollPane(fieldErrorDetails, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
