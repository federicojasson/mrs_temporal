...
public class AddRecord extends JFrame {
	...
	private void initGUI() {
		...
		/*
		 * dataFecha = new UtilDateModel(); JDatePanelImpl datePanel = new
		 * JDatePanelImpl(dataFecha); JDatePickerImpl Fecha = new
		 * JDatePickerImpl(datePanel); basicDataPane.add(Fecha,
		 * "4, 1, fill, default");
		 */
